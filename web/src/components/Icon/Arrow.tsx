...
export function Arrow({ direction, fill = '#597EF7' }: ArrowProps) {
    const arrowUp = (fill: string) => (
    ...
    return direction === 'up' ? arrowUp(fill) : arrowDown(fill);
}
