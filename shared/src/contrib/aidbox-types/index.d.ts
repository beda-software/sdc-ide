...
export type InternalReference<T extends Resource = any> = Omit<
  Reference<T>,
  "id"
> &
  Required<Pick<Reference<T>, "id">>;
/** Reference to external resource that is accessible via uri */
export type ExternalReference<T extends Resource = any> = Omit<
  Reference<T>,
  "uri"
> &
  Required<Pick<Reference<T>, "uri">>;
/** Logical reference that must have identifier */
export type LogicalReference<T extends Resource = any> = Omit<
  Reference<T>,
  "identifier"
> &
  Required<Pick<Reference<T>, "identifier">>;
/** Reference to contained resource */
export type LocalReference<T extends Resource = any> = Omit<
  Reference<T>,
  "localRef"
> &
...
export interface ActivityDefinition {
  ...
  observationResultRequirement?: Array<
    InternalReference<ObservationDefinition>
  >;
...
export interface AdverseEvent {
  ...
  contributor?: Array<
    InternalReference<Practitioner | PractitionerRole | Device>
  >;
...
export interface Claim {
  ...
  prescription?: InternalReference<
    DeviceRequest | MedicationRequest | VisionPrescription
  >;
...
export interface ClaimResponseAddItem {
  ...
  provider?: Array<
    InternalReference<Practitioner | PractitionerRole | Organization>
  >;
  /** Count of products or services */
  quantity?: Quantity;
  /** Date or dates of service or product delivery */
...
export interface ConditionStage {
  ...
  assessment?: Array<
    InternalReference<ClinicalImpression | DiagnosticReport | Observation>
  >;
  /** Additional content defined by implementations */
  extension?: Extension[];
  /** Unique id for inter-element referencing */
...
export interface DocumentReference {
  ...
  authenticator?: InternalReference<
...
export interface EnrollmentResponse {
  ...
  /** Responsible practitioner */
  requestProvider?: InternalReference<
    Practitioner | PractitionerRole | Organization
  >;
  /** active | cancelled | draft | entered-in-error */
  status?: code;
...
export interface Immunization {
  ...
  /** Why immunization occurred */
  reasonReference?: Array<
    InternalReference<Condition | Observation | DiagnosticReport>
  >;
...
export interface ImmunizationRecommendationRecommendation {
  ...
  supportingImmunization?: Array<
    InternalReference<Immunization | ImmunizationEvaluation>
  >;
...
export interface MedicationStatement {
  ...
  basedOn?: Array<
    InternalReference<MedicationRequest | CarePlan | ServiceRequest>
  >;
  /** Type of medication usage */
  category?: CodeableConcept;
  /** Contained, inline Resources */
...
export interface MedicinalProduct {
  ...
  pharmaceuticalProduct?: Array<
    InternalReference<MedicinalProductPharmaceutical>
  >;
...
export interface MedicinalProductIndication {
  ...
  undesirableEffect?: Array<
    InternalReference<MedicinalProductUndesirableEffect>
  >;
}
...
export interface Observation {
  ...
  hasMember?: Array<
    InternalReference<Observation | QuestionnaireResponse | MolecularSequence>
  >;
...
export interface Patient {
  ...
  generalPractitioner?: Array<
    InternalReference<Organization | Practitioner | PractitionerRole>
  >;
...
export interface Procedure {
  ...
  /** Part of referenced event */
  partOf?: Array<
    InternalReference<Procedure | Observation | MedicationAdministration>
  >;
  /** When the procedure was performed */
  ...
  report?: Array<
    InternalReference<DiagnosticReport | DocumentReference | Composition>
  >;
  /** preparation | in-progress | not-done | suspended | aborted | completed | entered-in-error | unknown */
  status: code;
  /** Reason for current status */
...
export interface ServiceRequest {
  ...
  /** What request fulfills */
  basedOn?: Array<
    InternalReference<CarePlan | ServiceRequest | MedicationRequest>
  >;
  /** Location on Body */
  bodySite?: CodeableConcept[];
